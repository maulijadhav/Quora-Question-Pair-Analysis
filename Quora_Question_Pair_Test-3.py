...
actual   0           1[alpha]
         1[Bita]     0
alpha -> (actual No dupluicate but Model said duplicated) 
Bita -> (Actual duplicate but model said Non duplicated)
so here alpha error is danger than bita.
Hence we consider Random forest Model not XG-Boost Model
# In[55]:
